...
public class TGQ_Payment_Page extends TGQAllPages {
	...
	public void paymenttab() throws MyOwnException, InterruptedException {
		log.info("METHOD(login) STARTED SUCCESSFULLY");
		try {
			if (MyWebElement.isCloseButtonExist("//*[@src='images/popup_close.gif']")) {
				driver.findElement(By.xpath("//*[@src='images/popup_close.gif']")).click();
			}
			...
			Base.screenShot(System.getProperty("user.dir")+"\\Results\\Screenshots_" + testRunTimeStamp + "/" + "PaymentTab.png");
			reportVar.logTestCaseStatusWithSnapShot(parentTestCase, "PASS", "PaymentTab",
					System.getProperty("user.dir")+"\\Results\\Screenshots_" + testRunTimeStamp + "/" + "PaymentTab.png");
			process_payment_button.click();
			Thread.sleep(4000);
		} catch (Exception exp) {
			log.error(exp.getMessage());
			Base.screenShot(System.getProperty("user.dir")+"\\Results\\Screenshots_" + testRunTimeStamp + "/" + "Error in Opening PaymentTab.png");
			reportVar.logTestCaseStatusWithSnapShot(parentTestCase, "FAIL",
					"<font color=red><b>Error while Opening PaymentTab: </b></font><br />" + exp.getMessage()
							+ "<br />",
					System.getProperty("user.dir")+"\\Results\\Screenshots_" + testRunTimeStamp + "/" + "Error in Opening PaymentTab.png");
			throwException("Unable To open the PaymentTab \n" + exp.getMessage() + "\n");
		}
